...
const booksDate = getCurItems('harvest/i-know', true, false)
const studyNotesDate = getCurItems('harvest/study-notes', true, false)
const studyDifficultyDate = getCurItems('harvest/difficulty', true, false)
